...
| [ADR-0006](adr/ADR-0006-transactional-album-mapping.md) | **accepted** 2026-09-21, Art Curator maintainers; SQLite WAL mapping backend selected; G5 implementation/qualification remains partial |
